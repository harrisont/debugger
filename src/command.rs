...
pub mod grammar {
    ...
    pub enum CommandExpr {
        ...
        BreakpointAdd(#[rust_sitter::leaf(text = "breakpoint-add")] (), Box<EvalExpr>),
        BreakpointAddAlias(#[rust_sitter::leaf(text = "ba")] (), Box<EvalExpr>),
        BreakpointRemove(#[rust_sitter::leaf(text = "breakpoint-remove")] (), Box<EvalExpr>),
        BreakpointRemoveAlias(#[rust_sitter::leaf(text = "br")] (), Box<EvalExpr>),
        BreakpointList(#[rust_sitter::leaf(text = "breakpoint-list")] ()),
        BreakpointListAlias(#[rust_sitter::leaf(text = "bl")] ()),
